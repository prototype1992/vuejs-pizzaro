...
<html lang="en-US" itemscope="itemscope" itemtype="http://schema.org/WebPage">
   ...
   <body class="home-v6 page-template-template-homepage-v6 woocommerce-active">
                  ...
                  <main id="main" class="site-main" >
                     ...
                     <div class="banners">
                        <div class="row">
                           <div class="banner col-sm-4" >
                              <a href="#">
                                 <div class="banner-bg" style="background-size: cover; background-position: center center; background-image: url( assets/images/homepage-banners/27.jpg ); height: 255px;">
                                    <div class="caption">
                           ...
                           <div class="banner col-sm-4" >
                              <a href="#">
                                 <div class="banner-bg" style="background-size: cover; background-position: center center; background-image: url( assets/images/homepage-banners/28.jpg ); height: 255px;">
                                    <div class="caption">
                                       <h3 class="title">CHICKEN WRAP</h3>
                                       <h4 class="subtitle">SPECIALS</h4>
                                       <span class="condition"><em>*</em>ONLY IN LOCAL</span>
                                    </div>
                                 </div>
                              </a>
                           </div>
                           <div class="banner col-sm-4 center" >
                              <a href="#">
                                 <div class="banner-bg" style="background-size: cover; background-position: center center; background-image: url( assets/images/homepage-banners/29.jpg ); height: 255px;">
                                    <div class="caption">
                     ...
                     <div class="products-card" >
                        <div class="media">
                           <div class="media-body">
                              <img width="810" height="919" src="assets/images/products/3.jpg" alt="" />
                           </div>
                           <div class="media-left media-middle">
                              <div class="products-1">
                                 <div class="woocommerce columns-1">
                                    <ul class="products">
                                       <li class="post-82 product type-product status-publish has-post-thumbnail product_cat-pizza first instock shipping-taxable purchasable product-type-simple addon-product">
                                          <div class="product-outer">
                                             <div class="product-inner">
                                                <div class="product-image-wrapper">
                                                   <a href="single-product-v2.html" class="woocommerce-LoopProduct-link"><img width="300" height="300" src="assets/images/products/p1.jpg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="13" title="13"  /></a>
                                                </div>
                     ...
                     <div class="products-card" >
                        <div class="media">
                           ...
                           <div class="media-body">
                              <img width="810" height="919" src="assets/images/products/4.jpg" alt="" />
                           </div>
                        </div>
                     </div>
                     <div class="products-card" >
                        <div class="media">
                           <div class="media-body">
                              <img width="810" height="813" src="assets/images/products/5.jpg" alt="" />
                              <div class="caption">
                                 <h3 class="section-title">Veggie</h3>
                              </div>
                           </div>
                           <div class="media-left media-middle">
                              <div class="products-2">
                                 <div class="woocommerce columns-2">
                                    <ul class="products">
                                       <li class="post-56 product type-product status-publish has-post-thumbnail product_cat-pizza pa_food-type-meat first instock shipping-taxable purchasable product-type-simple addon-product">
                                          <div class="product-outer">
                                             <div class="product-inner">
                                                <div class="product-image-wrapper">
                                                   <a href="single-product-v1.html" class="woocommerce-LoopProduct-link"><img width="300" height="300" src="assets/images/products/p3.jpg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="11" title="11"  /></a>
                                                </div>
                                                <div class="product-content-wrapper">
                                       ...
                                       <li class="post-53 product type-product status-publish has-post-thumbnail product_cat-pizza last instock featured shipping-taxable purchasable product-type-simple addon-product">
                                          <div class="product-outer">
                                             <div class="product-inner">
                                                <div class="product-image-wrapper">
                                                   <a href="single-product-v3.html" class="woocommerce-LoopProduct-link"><img width="300" height="300" src="assets/images/products/p4.jpg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="4" title="4" /></a>
                                                </div>
                                                <div class="product-content-wrapper">
                                                   ...
                                                   <div class="hover-area"><a rel="nofollow" href="single-product-v2.html" data-quantity="1" data-product_id="53" data-product_sku="" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Select Options</a></div>
                                                </div>
                                             </div>
                                             <!-- /.product-inner -->
                                          </div>
                        ...
                        <div class="media">
                           <div class="media-right media-middle">
                              <div class="products-2">
                                 <div class="woocommerce columns-2">
                                    <ul class="products">
                                       <li class="post-181 product type-product status-publish has-post-thumbnail product_cat-pasta pa_food-type-spicy first instock shipping-taxable purchasable product-type-simple addon-product">
                                          <div class="product-outer">
                                             <div class="product-inner">
                                                <div class="product-image-wrapper">
                                                   <a href="single-product-v1.html" class="woocommerce-LoopProduct-link"><img width="300" height="300" src="assets/images/products/p28.jpg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="46" title="46" /></a>
                                                </div>
                                                <div class="product-content-wrapper">
                                                   <a href="single-product-v1.html" class="woocommerce-LoopProduct-link">
                                                      <h3>Tagliatelle Molto</h3>
                                                   ...
                                                   <div class="hover-area"><a rel="nofollow" href="single-product-v2.html" data-quantity="1" data-product_id="181" data-product_sku="" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Select Options</a></div>
                                                </div>
                                             </div>
                                             <!-- /.product-inner -->
                                          </div>
                                       ...
                                       <li class="post-187 product type-product status-publish has-post-thumbnail product_cat-pasta pa_food-type-spicy last instock shipping-taxable purchasable product-type-simple addon-product">
                                          <div class="product-outer">
                                             <div class="product-inner">
                                                <div class="product-image-wrapper">
                                                   <a href="single-product-v2.html" class="woocommerce-LoopProduct-link"><img width="300" height="300" src="assets/images/products/p29.jpg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="40" title="40" /></a>
                                                </div>
                                                <div class="product-content-wrapper">
                                                   <a href="single-product-v2.html" class="woocommerce-LoopProduct-link">
                                                   ...
                                                   <div class="hover-area"><a rel="nofollow" href="single-product-v2.html" data-quantity="1" data-product_id="187" data-product_sku="" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Select Options</a></div>
                                                </div>
                                             </div>
                                             <!-- /.product-inner -->
                                          </div>
                           ...
                           <div class="media-body">
                              <img width="810" height="813" src="assets/images/products/6.jpg" alt="" />
                              <div class="caption">
                                 <h3 class="section-title">Pasta</h3>
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="products-card" >
                        <div class="media">
                           <div class="media-body">
                              <img width="810" height="922" src="assets/images/products/7.jpg" alt="" />
                              <div class="caption">
                                 <h3 class="section-title">Burgers</h3>
                              </div>
                           </div>
                           <div class="media-left media-middle">
                              <div class="products-4">
                                 <div class="woocommerce columns-2">
                                    <ul class="products">
                                       <li class="post-244 product type-product status-publish has-post-thumbnail product_cat-burgers pa_food-type-veg first instock shipping-taxable purchasable product-type-simple addon-product">
                                          <div class="product-outer">
                                             <div class="product-inner">
                                                <div class="product-image-wrapper">
                                                   <a href="single-product-v3.html" class="woocommerce-LoopProduct-link"><img width="300" height="300" src="assets/images/products/p3.png" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="" title="" /></a>
                                                </div>
                                                <div class="product-content-wrapper">
                                                   <a href="single-product-v3.html" class="woocommerce-LoopProduct-link">
                                                   ...
                                                   <div class="hover-area"><a rel="nofollow" href="single-product-v2.html" data-quantity="1" data-product_id="244" data-product_sku="" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Select Options</a></div>
                                                </div>
                                             </div>
                                             <!-- /.product-inner -->
                                          </div>
                                       ...
                                       <li class="post-136 product type-product status-publish has-post-thumbnail product_cat-burgers pa_food-type-veg last instock shipping-taxable purchasable product-type-simple addon-product">
                                          <div class="product-outer">
                                             <div class="product-inner">
                                                <div class="product-image-wrapper">
                                                   <a href="single-product-v3.html" class="woocommerce-LoopProduct-link"><img width="300" height="300" src="assets/images/products/p4.png" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="39" title="39" /></a>
                                                </div>
                                                <div class="product-content-wrapper">
                                                   <a href="single-product-v3.html" class="woocommerce-LoopProduct-link">
                                                   ...
                                                   <div class="hover-area"><a rel="nofollow" href="single-product-v2.html" data-quantity="1" data-product_id="136" data-product_sku="" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Select Options</a></div>
                                                </div>
                                             </div>
                                             <!-- /.product-inner -->
                                          </div>
                                       ...
                                       <li class="post-125 product type-product status-publish has-post-thumbnail product_cat-burgers pa_food-type-meat first instock shipping-taxable purchasable product-type-simple addon-product">
                                          <div class="product-outer">
                                             <div class="product-inner">
                                                <div class="product-image-wrapper">
                                                   <a href="single-product-v2.html" class="woocommerce-LoopProduct-link"><img width="300" height="300" src="assets/images/products/p1.png" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="37" title="37" /></a>
                                                </div>
                                                <div class="product-content-wrapper">
                                                   <a href="single-product-v2.html" class="woocommerce-LoopProduct-link">
                                                      <h3>Bacon Burger</h3>
                                                   ...
                                                   <div class="hover-area"><a rel="nofollow" href="single-product-v2.html" data-quantity="1" data-product_id="125" data-product_sku="" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Select Options</a></div>
                                                </div>
                                             </div>
                                             <!-- /.product-inner -->
                                          </div>
                                       ...
                                       <li class="post-245 product type-product status-publish has-post-thumbnail product_cat-burgers pa_food-type-veg last instock shipping-taxable purchasable product-type-simple addon-product">
                                          <div class="product-outer">
                                             <div class="product-inner">
                                                <div class="product-image-wrapper">
                                                   <a href="single-product-v1.html" class="woocommerce-LoopProduct-link"><img width="300" height="300" src="assets/images/products/p2.png" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="36" title="36" /></a>
                                                </div>
                                                <div class="product-content-wrapper">
                                                   <a href="single-product-v1.html" class="woocommerce-LoopProduct-link">
                                                      <h3>Double Cheese</h3>
                                                   ...
                                                   <div class="hover-area"><a rel="nofollow" href="single-product-v2.html" data-quantity="1" data-product_id="245" data-product_sku="" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Select Options</a></div>
                                                </div>
                                             </div>
                                             <!-- /.product-inner -->
                                          </div>
                        ...
                        <div class="media">
                           <div class="media-right media-middle">
                              <div class="products-4">
                                 <div class="woocommerce columns-2">
                                    <ul class="products">
                                       <li class="post-145 product type-product status-publish has-post-thumbnail product_cat-cold-drinks first instock shipping-taxable purchasable product-type-simple addon-product">
                                          <div class="product-outer">
                                             <div class="product-inner">
                                                <div class="product-image-wrapper">
                                                   <a href="single-product-v3.html" class="woocommerce-LoopProduct-link"><img width="300" height="300" src="assets/images/homepage-banners/gallery/gallery-12.jpg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="28" title="28" /></a>
                                                </div>
                                                <div class="product-content-wrapper">
                                                   <a href="single-product-v3.html" class="woocommerce-LoopProduct-link">
                                                      <h3>Orange Juice</h3>
                                                      <div  class="yith_wapo_groups_container">
                                                         <div class="ywapo_group_container ywapo_group_container_radio form-row form-row-wide " data-requested="1" data-type="radio" data-id="12" data-condition="">
                                                            <h3><span>Pick Size</span></h3>
                                                            <div class="ywapo_input_container ywapo_input_container_radio"><span class="ywapo_label_tag_position_after"><span class="ywapo_option_label ywapo_label_position_after">200ml</span></span><span class="ywapo_label_price"> <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>3.90</span></span></div>
                                                            <div class="ywapo_input_container ywapo_input_container_radio"><span class="ywapo_label_tag_position_after"><span class="ywapo_option_label ywapo_label_position_after">500ml</span></span><span class="ywapo_label_price"> <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>5.90</span></span></div>
                                                         </div>
                                                      </div>
                                                      <span class="price"><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>1.90</span></span>
                                                   </a>
                                                   <div class="hover-area"><a rel="nofollow" href="single-product-v2.html" data-quantity="1" data-product_id="145" data-product_sku="" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Select Options</a></div>
                                                </div>
                                             </div>
                                             <!-- /.product-inner -->
                                          </div>
                                       ...
                                       <li class="post-147 product type-product status-publish has-post-thumbnail product_cat-cold-drinks last instock shipping-taxable purchasable product-type-simple addon-product">
                                          <div class="product-outer">
                                             <div class="product-inner">
                                                <div class="product-image-wrapper">
                                                   <a href="single-product-v1.html" class="woocommerce-LoopProduct-link"><img width="300" height="300" src="assets/images/products/p30.jpg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="24" title="24" /></a>
                                                </div>
                                                <div class="product-content-wrapper">
                                                   <a href="single-product-v1.html" class="woocommerce-LoopProduct-link">
                                                      <h3>Tropicana Juice</h3>
                                                      <div  class="yith_wapo_groups_container">
                                                         <div class="ywapo_group_container ywapo_group_container_radio form-row form-row-wide " data-requested="1" data-type="radio" data-id="12" data-condition="">
                                                            <h3><span>Pick Size</span></h3>
                                                            <div class="ywapo_input_container ywapo_input_container_radio"><span class="ywapo_label_tag_position_after"><span class="ywapo_option_label ywapo_label_position_after">200ml</span></span><span class="ywapo_label_price"> <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span>3.90</span></span></div>
                                                   ...
                                                   <div class="hover-area"><a rel="nofollow" href="single-product-v2.html" data-quantity="1" data-product_id="147" data-product_sku="" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Select Options</a></div>
                                                </div>
                                             </div>
                                             <!-- /.product-inner -->
                                          </div>
                                       ...
                                       <li class="post-149 product type-product status-publish has-post-thumbnail product_cat-cold-drinks product_cat-smoothies first instock shipping-taxable purchasable product-type-simple addon-product">
                                          <div class="product-outer">
                                             <div class="product-inner">
                                                <div class="product-image-wrapper">
                                                   <a href="single-product-v2.html" class="woocommerce-LoopProduct-link"><img width="300" height="300" src="assets/images/homepage-banners/gallery/gallery-9.jpg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="82" title="82" /></a>
                                                </div>
                                                <div class="product-content-wrapper">
                                                   <a href="single-product-v2.html" class="woocommerce-LoopProduct-link">
                                                      <h3>Kiwi Smoothie</h3>
                                                   ...
                                                   <div class="hover-area"><a rel="nofollow" href="single-product-v2.html" data-quantity="1" data-product_id="149" data-product_sku="" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Select Options</a></div>
                                                </div>
                                             </div>
                                             <!-- /.product-inner -->
                                          </div>
                                       ...
                                       <li class="post-151 product type-product status-publish has-post-thumbnail product_cat-cold-drinks last instock shipping-taxable purchasable product-type-simple addon-product">
                                          <div class="product-outer">
                                             <div class="product-inner">
                                                <div class="product-image-wrapper">
                                                   <a href="single-product-v2.html" class="woocommerce-LoopProduct-link"><img width="300" height="300" src="assets/images/homepage-banners/gallery/gallery-7.jpg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="33" title="33" /></a>
                                                </div>
                                                <div class="product-content-wrapper">
                                                   <a href="single-product-v2.html" class="woocommerce-LoopProduct-link">
                                                      <h3>Iced Tea</h3>
                                                   ...
                                                   <div class="hover-area"><a rel="nofollow" href="single-product-v2.html" data-quantity="1" data-product_id="151" data-product_sku="" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Select Options</a></div>
                                                </div>
                                             </div>
                                             <!-- /.product-inner -->
                                          </div>
                           ...
                           <div class="media-body">
                              <img width="809" height="922" src="assets/images/products/8.jpg" alt="" />
                              <div class="caption">
                     ...
                     <div class="banner center" >
                        <a href="#">
                           <div class="banner-bg" style="background-size: cover; background-position: center center; background-image: url( assets/images/homepage-banners/30.jpg ); height: 231px;">
                              <div class="caption">
                                 <h3 class="title">FREE DELIVERY IN YOUR CITY</h3>
                                 <h4 class="subtitle">ON ORDERS FOR OVER 68$</h4>
                              </div>
                           </div>
                        </a>
                     </div>
