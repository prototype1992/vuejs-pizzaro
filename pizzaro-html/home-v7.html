            ...
            <div class="col-full">
               <div id="primary" class="content-area">
                  <main id="main" class="site-main" >
                     ...
                     <div class="stretch-full-width section-coupon" >
                        <div class="coupon-bg" style="background-size: cover; background-position: center center; background-image: url( assets/images/homepage-banners/31.jpg );">
                           <div class="caption">
                              <div class="caption-inner">
                                 ...
                                 <div class="coupon-info">
                                    <h4 class="pretitle">CRUST PIZZA</h4>
                                    <h3 class="title">BIG MEAL DEAL WITH PIZZA AND ICED COLA CUP</h3>
                                    <a href="shop-grid-3-column.html" class="button">CLICK TO USE THE COUPON</a>
                                 </div>
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="stretch-full-width section-sale-product"  style="background-size: cover; background-position: center center; background-image: url( assets/images/homepage-banners/32.jpg ); height: 803px;">
                        <div class="container">
                           <div class="product-wrapper">
                              <div class="product-inner">
                                 <div class="price-action">
                                    ...
                                    <a href="single-product-v1.html" class="button">Check the Deal</a>
                                 </div>
                                 <div class="product-content">
                                    <a href="single-product-v1.html" class="woocommerce-LoopProduct-link">
                                       <h3>GRAND <span>ITALIANO</span></h3>
                        ...
                        <div class="row">
                           <div class="col-md-6 col-sm-6 no-padding">
                              <div class="banner center social-block" >
                                 <a href="#">
                                    <div class="banner-bg" style="background-size: cover; background-position: center center; background-image: url( assets/images/homepage-banners/33.jpg ); ">
                                       <div class="caption">
                           ...
                           <div class="col-md-6 col-sm-6 no-padding">
                              <div class="section-recent-post"  style="background-size: cover; background-position: center center; background-image: url( assets/images/homepage-banners/34.jpg );">
                                 <div class="post-wrap">
                                    <h2 class="section-title">Summer Taste</h2>
                                    <div class="post-item">
                                       <div class="post-info">
                                          <h3 class="post-title"><a href="single-product-v2.html">Iced Caramel Latte</a></h3>
                                          <p>Quisque pretium turpis non tempus cursus. Nulla consequat, mi nec pellentesque imperdiet, mi quam congue magna, tristique commodo.</p>
                                          <a class="btn-more" href="single-product-v2.html">Read more</a>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                     ...
                     <div class="stretch-full-width section-store-search"  style="background-size: cover; background-position: center center; background-image: url( assets/images/homepage-banners/35.jpg ); min-height: 785px;">
                     ...
                     <section class="section-recent-posts" >
                        ...
                        <div class="post-items">
                           <div class="post-item">
                              ...
                              <img width="1619" height="827" src="assets/images/blog/blog-2.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" />
                              </a>
                              <div class="post-info">
                                 <h3 class="post-title">
                                    <a href="blog-single.html">5th International Pizza Festival with New Better Competitors from All over the World.</a>
                                 </h3>
                                 ...
                                 <a class="btn-more" href="blog-single.html">Read more</a>
                              </div>
                           </div>
                           <div class="post-item">
                              <a class="post-thumbnail" href="blog-single.html">
                              <img width="1619" height="827" src="assets/images/blog/blog-3.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" />
                              </a>
                              <div class="post-info">
                                 <h3 class="post-title">
                                    <a href="blog-single.html">Introducing Original Burger Sets New Line: My line of Hot &#038; Spicy Paprika.</a>
                                 </h3>
                                 <p>Mauris mi orci, placerat in pulvinar vitae, blandit eget nibh. Nam vitae erat ut purus dignissim rutrum nec nec nisi. Suspendisse dapibus magna id sapien</p>
                                 <a class="btn-more" href="blog-single.html">Read more</a>
                              </div>
                           </div>
                           <div class="post-item">
                              <a class="post-thumbnail" href="blog-single.html">
                              <img width="1619" height="827" src="assets/images/blog/blog-4.jpg" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" />
                              </a>
                              <div class="post-info">
                                 <h3 class="post-title">
                                    <a href="blog-single.html">Breakfast New Menu Starting this May with New Deals of 2016 Year.</a>
                                 </h3>
                                 <p>Nam et arcu pulvinar, feugiat nisi ac, elementum ex. Quisque non scelerisque lectus. Pellentesque non rhoncus orci, non facilisis risus massa quis.</p>
                                 <a class="btn-more" href="blog-single.html">Read more</a>
                              </div>
                           </div>
                        </div>
