            ...
            <div class="header-wrap">
                ...
                <nav id="site-navigation" class="main-navigation" aria-label="Primary Navigation">
                    ...
                    <div class="handheld-navigation">
                        ...
                        <ul class="menu">
                            ...
                            <li class="menu-item ">
                                <a href="shop-grid-3-column.html">
                                    <i class="po po-burger"></i>Burgers
                                </a>
                            </li>
                            <li class="menu-item ">
                                <a href="shop-grid-3-column.html">
                                    <i class="po po-salads"></i>Salads
                                </a>
                            </li>
                            <li class="menu-item ">
                                <a href="shop-grid-3-column.html">
                                    <i class="po po-tacos"></i>Tacos
                                </a>
                            </li>
                            <li class="menu-item ">
                                <a href="shop-grid-3-column.html">
                                    <i class="po po-wraps"></i>Wraps
                                </a>
                            </li>
                            <li class="menu-item ">
                                <a href="shop-grid-3-column.html">
                                    <i class="po po-fries"></i>Fries
                                </a>
                            </li>
                            <li class="menu-item ">
                                <a href="shop-grid-3-column.html">
                ...
                <div class="header-info-wrapper">
                    <div class="header-phone-numbers">
                        <span class="intro-text">Время работы с 8:00 до 22:00</span>
                        <span class="phone-number">+7 925 049 26 00</span>
                    </div>
                    <ul class="site-header-cart-v2 menu">
                        <li class="cart-content ">
                            <a href="cart.html" title="View your shopping cart">
                                <i class="po po-scooter"></i>
                                <span>2 товара на сумму <b class="amount">$50.00</b></span>
                            </a>
                            <!--<ul class="sub-menu">-->
                                <!--<li>-->
                                    <!--<a href="cart.html" title="View your shopping cart">-->
            ...
            <div class="pizzaro-secondary-navigation">
                <nav class="secondary-navigation" aria-label="Secondary Navigation">
                    <ul class="menu">
                        ...
                        >
                            <a :href="item.link">
                                <i :class="item.classes"></i>{{item.text}}
                            </a>
                        </li>
                    </ul>
                </nav>
        ...
        data() {
			return {
				categories: [
					...
					{
						link: '/',
						classes: 'po po-burger',
						text: 'Burgers'
					},
					{
						link: '/',
						classes: 'po po-salads',
						text: 'Salads'
					},
					{
						link: '/',
